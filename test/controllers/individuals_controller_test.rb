...
class IndividualsControllerTest < ActionController::TestCase
  ...
  test "should create individual" do
    assert_difference('Individual.count') do
      post :create, individual: { chronic: @individual.chronic, current: @individual.current, heightFeet: @individual.heightFeet, heightInches: @individual.heightInches, male: @individual.male, weight: @individual.weight }
    end
  ...
  test "should update individual" do
    patch :update, id: @individual, individual: { chronic: @individual.chronic, current: @individual.current, heightFeet: @individual.heightFeet, heightInches: @individual.heightInches, male: @individual.male, weight: @individual.weight }
    assert_redirected_to individual_path(assigns(:individual))
  end
